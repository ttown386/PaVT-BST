...
#include "../../include/InternalBST.h"
#include <algorithm>

InternalBST::InternalBST() {
  root = nullptr;
}
 ...
 */
bool InternalBST::insert(int const &key) {
 ...
 */
bool InternalBST::remove(int const& key){
 ...
 */
bool InternalBST::contains(int const& key){
