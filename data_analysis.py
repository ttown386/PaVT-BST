...
fig = plt.figure(figsize=(6.5, 5))
ax1 = fig.add_subplot(111)
ax1.plot(x, bst, '-o', label="BST TS1", markersize=10, linewidth=2)
ax1.plot(x, bst2, '-o', label="BST TS2", markersize=10, linewidth=2, linestyle='--')
ax1.plot(x, bst3, '-o', label="BST TS3", markersize=10, linewidth=2, linestyle='-.')
ax1.plot(x, avl, '-^', label="AVL TS1", markersize=10, linewidth=2)
plt.legend(loc='upper left', shadow=True)
plt.xlabel('Threads', fontsize=14)
plt.ylabel('Throughput (MOps/sec)', fontsize=14)
ax1.tick_params(labelsize=12)
